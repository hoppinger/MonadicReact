...
let create_course_step1 : ((_:CreateCourseFormData) => C<CreateCourseFormData>) = cd =>
  ...
  button<CreateCourseFormData, CreateCourseFormData>(`next`)(cd => ({...cd, step:"points"})))
...
let create_course_step2 : ((_:CreateCourseFormData) => C<CreateCourseFormData>) = cd =>
  repeat<CreateCourseFormData>(cd =>
    ...
    any<CreateCourseFormData>([
      button<CreateCourseFormData, CreateCourseFormData>(`prev`)(cd => ({...cd, step:"name"})),
      button<CreateCourseFormData, CreateCourseFormData>(`next`)(cd => ({...cd, step:"recap"}))
    ])(cd))
...
let create_course_recap : ((_:CreateCourseFormData) => C<CreateCourseFormData>) = cd =>
  any<CreateCourseFormData>([
    ...
    button<CreateCourseFormData, CreateCourseFormData>(`prev`)(cd => ({...cd, step:"recap"})),
    button<CreateCourseFormData, CreateCourseFormData>(`next`)(cd => ({...cd, step:"sent"}))
  ])(cd)
