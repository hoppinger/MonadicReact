...
export let bool = (mode:Mode, style:BooleanStyle, key?:string) => function(value:boolean) : C<boolean> {
  return make_C<boolean>(cont => ({ kind:"bool", style:style, mode:mode, value:value, cont:cont, key:key }))
}
